...
import com.example.onyeshatalanta.Model.UploadSong;

import java.util.ArrayList;
import java.util.List;

public class    MusicUploading extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_music_uploading);
    ...
    public  void  openAlbumUploadsActivty(View v){
        Intent in = new Intent( MusicUploading.this, UploadAlbum.class);
        startActivity(in);
    }
